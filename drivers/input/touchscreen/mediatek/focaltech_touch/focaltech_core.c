 ...
 * need unregister the driver Input: Output: Return: return 0 if get correct ic
 * information, otherwise return error code
 *****************************************************************************/
 ...
 *		if point's coordinate is in (x_dim-50,y_dim-50) ~
 * (x_dim+50,y_dim+50), need report it to key event. x_dim: parse from dts,
 * means key x_coordinate, dimension:+-50 y_dim: parse from dts, means key
 * y_coordinate, dimension:+-50 Input: Output: Return: return 0 if it's key
 * event, otherwise return error code
 *****************************************************************************/
